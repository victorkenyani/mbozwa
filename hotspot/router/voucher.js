...
route.post('/', async (req, res) => {
  ...
  */
  ...
  const  data  = req.body;
  // console.log(data)
  const  minutes  = Number(data.amount)
  if (minutes == null) {
  ...
  try {
    ...
    // res.end(htss)
    // redirect(req,res,voucher_.voucher)
...
function redirect(req,res,voucher_) {
  res.writeHead(200,{"content-type":"text/html"});
  res.end(htss(voucher_.username))
}

function htss(username){
  ...
  -->
      ...
      $(if chap-id)
      <form name="sendin" action="http://mbozwa.spot/index.html" method="post" style="display:none">
      ...
      <div class="ie-fixMinHeight">
          <div class="main">
              <div class="wrap animated fadeIn">
                  <form name="login" action="http://mbozwa.spot/index.html" method="post" $(if chap-id) onSubmit="return doLogin()" $(endif)>
                      <input type="hidden" name="dst" value="$(link-orig)" />
                      <input type="hidden" name="popup" value="true" />
                      ...
                      <label>
                          ...
                          <input value="mbozwa" name="password" type="password" placeholder="Password" />
                      </label>
